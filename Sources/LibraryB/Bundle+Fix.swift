...
/*
 Unsure what the below values should be.
 - LibraryB doesn't work
 - spm-bug_LibraryB also doesn't work
 */
private let packageName: String = "spm-bug"
private let targetName: String = "LibraryB"
